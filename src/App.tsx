      ...
      <QueryClientProvider client={queryClient}>
        <ThemeProvider defaultTheme="system" storageKey="experts-coaching-hub-theme">
          ...
          <BrowserRouter>
            ...
            <Route path="/client/courses" element={<ProtectedRoute allowedRoles={["client"]}><ClientCourses /></ProtectedRoute>} />
            <Route path="/client/my-courses" element={<ProtectedRoute allowedRoles={["client"]}><MyCourses /></ProtectedRoute>} />
            <Route path="/client/course/:courseId" element={<ProtectedRoute allowedRoles={["client"]}><CourseViewer /></ProtectedRoute>} />
            ...
            <Route path="/coach/courses" element={<ProtectedRoute allowedRoles={["coach"]}><CoachCourses /></ProtectedRoute>} />
            <Route path="/coach/courses/create" element={<ProtectedRoute allowedRoles={["coach"]}><CreateCourse /></ProtectedRoute>} />
            <Route path="/coach/courses/:courseId/edit" element={<ProtectedRoute allowedRoles={["coach"]}><EditCourse /></ProtectedRoute>} />
            <Route path="/coach/sessions" element={<ProtectedRoute allowedRoles={["coach"]}><Sessions /></ProtectedRoute>} />
            <Route path="/coach/sessions/create" element={<ProtectedRoute allowedRoles={["coach"]}><CreateSession /></ProtectedRoute>} />
            <Route path="/coach/sessions/:meetingId" element={<ProtectedRoute allowedRoles={["coach"]}><MeetingRoom /></ProtectedRoute>} />
            <Route path="/coach/students" element={<ProtectedRoute allowedRoles={["coach"]}><Students /></ProtectedRoute>} />
            <Route path="/coach/schedule" element={<ProtectedRoute allowedRoles={["coach"]}><Schedule /></ProtectedRoute>} />
            <Route path="/coach/billing" element={<ProtectedRoute allowedRoles={["coach"]}><CoachBilling /></ProtectedRoute>} />
            <Route path="/coach/billing/success" element={<ProtectedRoute allowedRoles={["coach"]}><BillingSuccess /></ProtectedRoute>} />
            ...
            <Route path="/coach/analytics" element={<ProtectedRoute allowedRoles={["coach"]}><CoachAnalytics /></ProtectedRoute>} />
