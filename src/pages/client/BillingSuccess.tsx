...
import { CheckCircle, ArrowRight, MessageSquare, BookOpen } from "lucide-react";
            ...
            <CardContent className="text-center space-y-4">
              ...
              <div className="flex gap-4 justify-center">
                <Button asChild variant="outline">
                  <Link to="/client/packages">Try Again</Link>
                </Button>
                <Button asChild>
      ...
      <div className="max-w-2xl mx-auto">
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Welcome to your coaching subscription! You now have access to premium coaching services and personalized learning experiences.
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center space-y-6">
            ...
            <div className="space-y-4">
              <div className="text-left">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    Your coaching subscription is now active
                  </li>
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-4 h-4 mt-0.5 text-green-600" />
                    Check your email for invoice and access details
                  </li>
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-4 h-4 mt-0.5 text-green-600" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                <Card className="border-2 border-dashed">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Access your personalized coaching materials
                    </p>
                    <Button asChild size="sm" variant="outline">
                      <Link to="/client/my-courses">View My Courses</Link>
                    </Button>
                  </CardContent>
                </Card>
                ...
                <Card className="border-2 border-dashed">
                  <CardContent className="p-4 text-center">
                    ...
                    <Button asChild size="sm" variant="outline">
                      <Link to="/client/sessions">Schedule Session</Link>
                    </Button>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="flex gap-4 justify-center pt-4">
                <Button asChild variant="outline">
                  <Link to="/client/billing">View Billing</Link>
                </Button>
                <Button asChild>
